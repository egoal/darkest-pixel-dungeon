...
public class GameScene extends PixelScene {
	...
	public void create() {
		...
		super.create();
		Camera.main.zoom( GameMath.gate(minZoom, defaultZoom + DarkestPixelDungeon.zoom(), maxZoom));
	...
	public static void layoutTags() {
		...
		float tagLeft = DarkestPixelDungeon.flipTags() ? 0 : uiCamera.width - scene.attack.width();
