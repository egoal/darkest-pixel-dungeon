...
public class LastLevel extends Level {
  ...
  protected boolean build(int iterations) {
    ...
    map[pos - width()] = map[pos - 1] = map[pos + 1] = map[pos - 2] = map[pos
            + 2] = Terrain.WATER;
    pos += width();
    map[pos] = map[pos - 2] = map[pos + 2] = map[pos - 3] = map[pos + 3] = 
            Terrain.WATER;
    pos += width();
    map[pos - 3] = map[pos - 2] = map[pos - 1] = map[pos] = map[pos + 1] = 
            map[pos + 2] = map[pos + 3] = Terrain.WATER;
    pos += width();
