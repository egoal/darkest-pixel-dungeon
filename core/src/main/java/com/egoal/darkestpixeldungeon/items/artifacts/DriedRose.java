...
public class DriedRose extends Artifact {
    ...
    if (action.equals(AC_SUMMON)) {
      ...
      if (spawned) GLog.i(Messages.get(this, "spawned"));
        ...
        if (spawnPoints.size() > 0) {
          ...
          if (!firstSummon) {
            ghost.yell(Messages.get(GhostHero.class, "hello", Dungeon.hero
                    .givenName()));
  ...
  public static class GhostHero extends NPC {
    ...
    protected boolean getCloser(int target) {
      if (state == WANDERING || Dungeon.level.distance(target, Dungeon.hero
              .pos) > 6)
    ...
    protected Char chooseEnemy() {
      if (enemy == null || !enemy.isAlive() || !Dungeon.level.mobs.contains
              (enemy) || state == WANDERING) {

        HashSet<Mob> enemies = new HashSet<Mob>();
        for (Mob mob : Dungeon.level.mobs) {
          if (mob.hostile && Level.fieldOfView[mob.pos] && mob.state != mob
                  .PASSIVE) {
            enemies.add(mob);
          }
        }
    ...
    //************************************************************************************
    //This is a bunch strings & string arrays, used in all of the sad ghost's
    // voice lines.
    //************************************************************************************

    private static final String VOICE_INTRODUCE = "My spirit is bound to this" +
            " rose, it was very precious to me, a " +
            "gift from my love whom I left on the surface.\n\nI cannot return" +
            " to him, but thanks to you I have a " +
            "second chance to complete my journey. When I am able I will " +
            "respond to your call and fight with you.\n\n" +
    ...
    public static final String[][] VOICE_AMBIENT = {
            {
                    "These sewers were once safe, some even lived here in the" +
                            " winter...",
                    "I wonder what happened to the guard patrols, did they " +
                            "give up?...",
            ...
            "Something must have gone very wrong, for the dwarves to abandon " +
                    "a gold mine...",
            ...
            "... I don't like this place... We should leave as soon as " +
                    "possible..."
    }
    };
    ...
    public static final String[][][] VOICE_ENEMIES = {
            {
                    {
                            ...
                            "If the guards couldn't defeat them, perhaps we " +
                                    "can...",
                            "These crabs are extremely annoying..."
                    }, {
                    "Beware Goo!...",
                    "Many of my friends died to this thing, time for " +
                            "vengeance...",
            ...
            }, {
            {
                    ...
                    "To think the captives of this place are now its " +
                            "guardians...",
    ...
    }, {
            {
                    ...
                    "I don't know what's worse, the dwarves, or their " +
                            "creations...",
