...
public class WandOfFrost extends DamageWand {
  ...
  protected void fx(Ballistica bolt, Callback callback) {
    MagicMissile.blueLight(curUser.sprite.parent, bolt.sourcePos, bolt
  ...
  public void onHit(MagesStaff staff, Char attacker, Char defender, int 
    ...
    if (chill != null && Random.IntRange(2, 10) > chill.cooldown()) {
      ...
      // by taking damage from the staff hit.
      new FlavourBuff() {
        {
        ...
        public boolean act() {
          Buff.affect(target, Frost.class, Frost.duration(target) * Random
                  .Float(1f, 2f));
          return super.act();
        }
      }.attachTo(defender);
